...
Job Story 1
Когда мне нужно подготовить слайды для презентации, я хочу получать реалистичные изображения без визуальных искажений, чтобы я мог сразу вставлять их в слайды и не тратить время на ручную правку результатов.
Job To Be Done
Создать визуальный материал, который можно быстро использовать в презентации или другом контенте без дополнительной доработки.
Job Story 2
Когда я начинаю вводить короткий запрос для генерации изображения, я хочу получать релевантные подсказки для продолжения промпта, чтобы быстрее сформулировать полный и точный запрос и получить нужный результат.
Job To Be Done
Сформулировать точный запрос для создания нужного изображения на основе первоначальной идеи.
Job Story 3
Когда я часто использую похожие запросы для генерации изображений, я хочу сохранять и редактировать шаблоны промптов, чтобы быстро использовать их повторно.
Job To Be Done
Повторно использовать ранее сформулированные запросы для ускорения создания изображений.
Job Story 4
...
Job To Be Done
Определить визуальные характеристики будущего изображения, чтобы результат соответствовал ожидаемому стилю и композиции.
Job Story 5
Когда я ввожу короткий или недостаточно точный запрос для генерации изображения, я хочу, чтобы система задавала уточняющие вопросы, чтобы точнее сформулировать запрос.
Job To Be Done
Уточнить параметры будущего изображения, чтобы повысить точность результата генерации.
Job Story 6
Когда я получаю сгенерированное изображение, я хочу иметь возможность оценить результат и оставить комментарий, чтобы система могла учитывать мою обратную связь.
Job To Be Done
Оценить результат генерации изображения и зафиксировать обратную связь для улучшения будущих результатов.
Job Story 7
...
Job To Be Done
Быстро проверить соответствие результата первоначальной идее и при необходимости уточнить или скорректировать результат.
Job Story 8
Когда мне нужно быстро задать запрос для генерации изображения, я хочу иметь возможность вводить промпт текстом или голосом, чтобы выбрать наиболее удобный способ ввода.
Job To Be Done
Передать системе описание требуемого изображения наиболее удобным для пользователя способом.
Job Story 9
Когда я генерирую изображения в сервисе, я хочу, чтобы они автоматически сохранялись и могли быть скачаны, чтобы я мог использовать их позже.
Job To Be Done
Сохранить и получить доступ к созданным изображениям для их последующего использования.
Job Story 10
Когда при генерации изображения происходит сбой или сервис временно недоступен, я хочу получать информацию о статусе работы сервиса и иметь возможность повторить генерацию.
Job To Be Done
Завершить процесс создания изображения даже при возникновении технических проблем.
![image.png](image.png)
